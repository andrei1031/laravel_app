<x-guest-layout>
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div class="max-w-md w-full space-y-8 relative z-20">
            <!-- F1 Logo -->
            <div class="text-center">
                ...
                <p class="text-gray-300 text-lg font-medium tracking-widest uppercase">Sign in to join the grid</p>
            </div>

            <form
                class="space-y-6 bg-[#0d0d0d]/95 backdrop-blur-xl py-12 px-8 shadow-2xl rounded-3xl border border-gray-700/50"
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input id="remember_me" name="remember" type="checkbox"
                            class="h-5 w-5 text-red-500 rounded border-gray-600 bg-black/50 focus:ring-red-500">
                        <label for="remember_me" class="ml-3 block text-sm text-gray-300 font-medium">
                            Stay logged in
                        </label>
                    </div>
                    ...
                    @if (Route::has('password.request'))
                        <div class="text-sm">
                            <a href="{{ route('password.request') }}" class="font-bold text-red-400 hover:text-red-300">
                                Forgot code?
                            </a>
                        </div>
                    @endif
                ...
                <div class="text-center py-4">
                    <p class="text-sm text-gray-400">
                        New racer? <a href="{{ route('register') }}"
                            class="font-bold text-red-400 hover:text-red-300 uppercase tracking-wider">Join Now</a>
                    </p>
                </div>
            </form>
        </div>
